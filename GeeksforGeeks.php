...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `hello`.`geeksforgeeks` (`name`, `year`, `profile`, `email`, `phone`, `descript`, `dt`) VALUES ('$name', '$year', '$profile', '$email', '$phone', '$descript', current_timestamp());";
    // echo $sql;
...
<body>
    ...
    <div class="container">
        <h1>Geeks for Geeks</h3>
        
       
        <form action="GeeksforGeeks.php" method="post">
