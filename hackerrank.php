...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `hello`.`hackerrank` (`name`, `year`, `profile`, `email`, `phone`, `descript`, `dt`) VALUES ('$name', '$year', '$profile', '$email', '$phone', '$descript', current_timestamp());";
    // echo $sql;
...
<body>
    ...
    <div class="container">
        ...
        <form action="hackerrank.php" method="post">
